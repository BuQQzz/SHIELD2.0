...
import { validateFilesystemPath, OFFICIAL_MCP_SERVERS } from './MCPServerConfig';
...
describe('MCPServerConfig', () => {
  describe('validateFilesystemPath', () => {
    ...
    it('should normalize paths before validation', () => {
      const unnormalizedPath = path.join(os.homedir(), 'Documents', '..', 'Documents', 'test.txt');
  ...
  describe('OFFICIAL_MCP_SERVERS', () => {
    it('should define filesystem server configuration', () => {
      ...
      expect(OFFICIAL_MCP_SERVERS.filesystem.package).toBe('@modelcontextprotocol/server-filesystem');
